...
#if defined(NDEBUG)
# error "YYCcoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "YYCcoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s YYC additional fees, %d delta bytes\n",
...
static bool ContextualCheckBlockHeader(const CBlockHeader& block, CValidationState& state, const CChainParams& params, const CBlockIndex* pindexPrev, int64_t nAdjustedTime)
{
    ...
    if(Params().NetworkIDString() == CBaseChainParams::MAIN && nHeight <= 21590){
